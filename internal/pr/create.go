...
func Create(worktreePath, repoFullName, taskID, title string, labels []string) (string, error) {
	// Check for changes
...
Automated PR generated by [partio-io/minions](https://github.com/partio-io/minions).

**Task:** `+"`%s`"+`

---

*This PR was created by an unattended coding agent. Please review carefully.*`, taskID)
