...
| [ ]  | 8 | [Persona substrate: in-repo telos+memory, drop the external repo](./issues/08-persona-local-substrate.md) — **external clone already cut (cli#454)**; substrate TODO | None |
